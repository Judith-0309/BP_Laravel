function validate()
{
    ...
    var EtatCompte = document.getElementById('EtatCompte');
    ...
    if(typeCompte.value === ""){
        alert('remplir typeCompte');
        typeCompte.style.background = "#C82525";
        typeCompte.placeholder = "veuillez remplir ce champ";
    ...
    if(EtatCompte.value === ""){
        alert('remplir EtatCompte');
        EtatCompte.style.background = "#C82525";
        EtatCompte.placeholder = "veuillez remplir ce champ";
